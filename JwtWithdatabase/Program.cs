...
{
    options.UseSqlServer(builder.Configuration.GetConnectionString("connection"),sqlServerOptionsAction:sqloptions =>
    {
        sqloptions.EnableRetryOnFailure();
    });
});
builder.Services.AddTransient<ICommon, _Common>();
